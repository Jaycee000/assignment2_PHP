<?php 
	...
	//register user
	// Attempt to log in the user if the login form is submitted
	if (isset($_POST['submit'])) {
		...
		// Prepare and execute a query to select the user from the database
		...
		if ($select_user->rowCount() > 0) {
			...
			// Display a warning message for incorrect username or password
