...
<body>
	...
	<div class="main">
		...
		<!-- Section for displaying different coffee categories -->
		<div class="about-category">
		 ...
		 <!-- Section for displaying services with icons and details -->
		<section class="services">
			<div class="title">
				 <!-- Logo and title for the services section -->
		 ...
		 <!-- Section with details about visiting the showroom -->
		<div class="about">
			<div class="row">
				<div class="img-box">
					<img src="img/3.png">
		...
		<div class="testimonial-container">
			<div class="title">
				...
				<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto dolorum deserunt minus veniam
				 ...
				 <!-- Container for displaying testimonial items with images and text -->
                <div class="container">
